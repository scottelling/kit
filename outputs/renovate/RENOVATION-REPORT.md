...
> **REPORT READY** — Evidence is assembled; real project source was not changed.
...
|---|---|---|---|---|---|---|
| UI-002 | UI | **FIX** | high | `app/kit/os/os.css:49` | The five-theme selector is 126 pixels wider than its visible container at 390 pixels and 88 pixels wider at 430 pixels. Ethereal is clipped and Paper is not visible, while page-level overflow is suppressed. — /kit/os · 390x844 and 430x932 · initial | Browser-backed observation; source reachability and intended design authority still matter. |
| UI-003 | UI | **FIX** | low | `app/kit/shadow/shadow.css:765` | The Smooth Shadow attribution link is only 18 pixels tall and has no larger effective label target, violating the shared 44-pixel interaction floor. — /kit/shadow · all reviewed sizes · populated | Browser-backed observation; source reachability and intended design authority still matter. |
...
- This report reviews the four public kit showrooms, their shared entrance layout, representative populated content, and one phone preview. It does not claim exhaustive visual review of every state of all 147 OS pieces.
- Static code-rot and numeric scanner results are discovery leads only. No target-project commands, removal experiments, builds, source edits, commits, or deployment were performed.
