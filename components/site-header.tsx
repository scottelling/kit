...
const places = [
  ...
  { label: "Explore Calm Desktop", hint: "Use the quiet graphite system for dense editable desktop work", href: "/kit/calm", words: "calm graphite dark desktop native dense editable three pane command complete kit components" },
  ...
  { label: "Open the Vanilla starter", hint: "Try the same app, landing page, shop, and publication in every complete kit", href: "/vanilla", words: "vanilla project starter app landing shop content swap new project" },
