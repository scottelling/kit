...
const textTreatments: StudioAsset[] = [
  ...
  { id: "tabular-statement", category: "Text", name: "Tabular Statement", summary: "Aligned figures carry the message", bestFor: "Totals and product proof", detail: "Tabular numbers let values compare cleanly without inventing dramatic stat treatments.", sample: "179 pieces · 113 tools" },
