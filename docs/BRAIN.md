...
- `/studio/guides` makes one complete operating guide visible for every one of the 179 reusable pieces. Each guide defines purpose, named events, visible states, the Kit/product ownership line, accessibility, phone behavior, proof, links to all six systems, and a copyable English project request.
...
- The universal variable set (the intersection of all six complete systems'
