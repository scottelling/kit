...
The public design-engineering registry for Purple Rain, JADE, OS, and focused foundation kits.
...
Open `http://localhost:3000/kit` for Purple Rain, `http://localhost:3000/kit/jade` for JADE, `http://localhost:3000/kit/os` for OS, `http://localhost:3000/kit/shadow` for Shadow, and `http://localhost:3000/kit/jade/compare` for the matched-product comparison.
...
The counted inventories and shared capability contract keep all three visual systems aligned while their palettes, shapes, depth, motion, and system-specific structures remain distinct.
