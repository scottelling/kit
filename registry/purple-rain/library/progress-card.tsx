...
export function ProgressCard({ children, className, ...props }: ProgressCardProps) {
  if (children !== undefined) {
    return (<div data-slot="progress-card" className={cn("min-w-0 rounded-[var(--radius-card)] bg-card text-card-foreground", className)} {...props}>{children}</div>)
  }
