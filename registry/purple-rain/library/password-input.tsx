...
export function PasswordInput({ children, className, ...props }: PasswordInputProps) {
  if (children !== undefined) {
    return (<label data-slot="password-input" className={cn("grid min-w-0 gap-2", className)} {...props}>{children}</label>)
  }
