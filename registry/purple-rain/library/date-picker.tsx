...
export function DatePicker({ children, className, ...props }: DatePickerProps) {
  if (children !== undefined) {
    return (<label data-slot="date-picker" className={cn("grid min-w-0 gap-2", className)} {...props}>{children}</label>)
  }
