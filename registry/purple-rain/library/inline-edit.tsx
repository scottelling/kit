...
export function InlineEdit({ children, className, ...props }: InlineEditProps) {
  if (children !== undefined) {
    return (<label data-slot="inline-edit" className={cn("grid min-w-0 gap-2", className)} {...props}>{children}</label>)
  }
