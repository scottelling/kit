...
function auditProject(project: StudioProject): QualityCheck[] {
  ...
  return [
    ...
    { group: "Studio", name: "Working team", detail: "The project carries the specialists responsible for direction, product, build, and proof.", pass: project.agentIds?.length >= 4 },
    { group: "Studio", name: "Reusable abilities", detail: "The project carries the abilities needed to design, build, and prove the release.", pass: project.skillIds?.length >= 2 },
